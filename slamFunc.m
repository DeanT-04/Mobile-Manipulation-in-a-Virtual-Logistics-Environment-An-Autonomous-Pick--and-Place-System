function slamObj = slamFunc(clientID, sim, leftMotorHandle, rightMotorHandle)
    ...
    slamObj.LoopClosureThreshold = 1200; % Set loop closure threshold
    slamObj.LoopClosureSearchRadius = 6; % Set loop closure search radius
    slamObj.MovementThreshold = [0.001, 0.001];
    ...
    velocity = 3; % Speed for forward/backward motion
