function executePath(clientID, sim, path, pioneerHandle, leftMotorHandle, rightMotorHandle)
    ...
    Ki_linear = 0.0005; % Very low to avoid integral wind-up
    Kd_linear = 0.001;  % Smoother transitions, less oscillation

    Kp_angular = 0.6;  % Lower angular gain for gradual turns
    Ki_angular = 0.00001; % Reduced integral effect for better stability
